...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleSmallLengthPasswordException(SmallLengthPasswordException ex, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
    ...
    @ExceptionHandler(PasswordContainsException.class)
    public ResponseEntity<ErrorResponse> handlePasswordContainsException(PasswordContainsException ex, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
    ...
    @ExceptionHandler(IncorrectRepeatPasswordException.class)
    public ResponseEntity<ErrorResponse> handleIncorrectRepeatPasswordException(IncorrectRepeatPasswordException ex, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
    ...
    @ExceptionHandler(NameSessionIdNotFound.class)
    public ResponseEntity<ErrorResponse> handleNameSessionIdNotFound(NameSessionIdNotFound ex, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
    ...
    public ResponseEntity<ErrorResponse> handleCookiesNotFoundException(CookiesNotFoundException ex, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
    ...
    public ResponseEntity<ErrorResponse> handleLocationAlreadyExistsException(LocationAlreadyExistsException ex, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                HttpStatus.BAD_REQUEST.getReasonPhrase(),
